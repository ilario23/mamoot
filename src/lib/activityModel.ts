...
export interface PaceZoneRange {
  lowerSecPerKm: number | null;
  upperSecPerKm: number | null;
  source: 'none' | 'auto' | 'manual';
  confidence: number | null;
  sampleSize: number | null;
  updatedAt: number | null;
  autoGeneratedAt: number | null;
  methodVersion: string | null;
}

const createDefaultPaceZoneRange = (): PaceZoneRange => ({
  lowerSecPerKm: null,
  upperSecPerKm: null,
  source: 'none',
  confidence: null,
...
export const createDefaultPaceZones = (): NonNullable<UserSettings['paceZones']> => ({
  z1: createDefaultPaceZoneRange(),
  z2: createDefaultPaceZoneRange(),
  z3: createDefaultPaceZoneRange(),
  z4: createDefaultPaceZoneRange(),
  z5: createDefaultPaceZoneRange(),
  z6: createDefaultPaceZoneRange(),
});
...
export const defaultSettings: UserSettings = {
  ...
  paceZones: createDefaultPaceZones(),
  goal: '',
  allergies: [],
  foodPreferences: '',
  injuries: [],
