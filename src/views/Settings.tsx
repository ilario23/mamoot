  ...
  const handleForceRefresh = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          'Could not refresh activities from Strava. Please try again.',
        variant: 'destructive',
      });
    } finally {
    ...
    <div className='space-y-6 w-full max-w-4xl mx-auto'>
        ...
        <div className='space-y-3'>
          <div className='flex items-center gap-3'>
            ...
            <div className='flex-1'>
              <p className='font-black text-sm'>Language Model</p>
              <p className='text-xs font-bold text-muted-foreground'>
                Select the AI model used by Coach, Nutritionist, and Physio.
              </p>
            </div>
          </div>
          <div className='relative'>
            <select
              value={formState.aiModel ?? DEFAULT_MODEL}
              onChange={(e) =>
                setFormState((prev) => ({...prev, aiModel: e.target.value}))
              }
          ...
          <div className='space-y-4'>
            {zoneKeys.map((zone, i) => {
              ...
              return (
                <div
                  key={zone}
                  className='flex items-center gap-2 md:gap-3 flex-wrap sm:flex-nowrap'
                >
                  <div
      ...
      <div className='border-3 border-border p-5 bg-background shadow-neo space-y-6'>
        <div>
          ...
          <p className='text-xs font-bold text-muted-foreground mt-1'>
            This information is shared with the Nutritionist to personalize
            dietary advice.
          </p>
        </div>
      ...
      <div className='border-3 border-border p-5 bg-background shadow-neo space-y-6'>
        <div>
          ...
          <p className='text-xs font-bold text-muted-foreground mt-1'>
            This information is shared with Coach and Physio to adapt training
